...
async function release(args) {
  ...
  const versionResult = exec(`npm version ${versionBump} -m 'New release: %s'`);
...
(async function __init() {
  return yargs
    ...
    .command(
      'bumpModules',
      'bumps the version in all submodules without tagging or making the release commit in git',
      bumpModules
    )
    .demandCommand(1)
    .argv
